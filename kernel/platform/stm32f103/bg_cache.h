 ...
 * SD-writing half here is hardware-independent (it talks to fat32lite only) and is
...
/* Create/truncate `path` and start a new reassembly. Returns 0 or a FAT32LITE_E*. */
 ...
 * final chunk and closes the file. Returns 0 on success, a negative FAT32LITE_E* on
