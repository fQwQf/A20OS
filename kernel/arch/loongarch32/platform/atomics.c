...
/*
 * NaiLoong (LA32R) has no lr.d/sc.d, so GCC's 64-bit atomic builtins cannot
 * be realized in hardware.  Implement them by disabling interrupts around a
 * plain double-word read-modify-write, as riscv32 does.
 */
