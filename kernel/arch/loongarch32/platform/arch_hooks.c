/*
 * LoongArch32 architecture extension hooks: Linux ABI ptrace register-file
 * layout and drvmod MMIO direct-map window validation.
 */
...
/* Identity-mapped (PAGE_OFFSET == 0): VA == PA, 32-bit address space. */
...
int linux_arch_fpregs_count(void) { return 32; }
