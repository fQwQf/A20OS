#ifndef _ARCH_LOONGARCH64_SIGNAL_ABI_H
#define _ARCH_LOONGARCH64_SIGNAL_ABI_H
...
static inline arch_sigframe_extra_t *arch_sigframe_extra_ptr(arch_sig_rt_frame_t *frame) { return &frame->arch_extra; }

#endif /* _ARCH_LOONGARCH64_SIGNAL_ABI_H */
