...
_Static_assert(sizeof(trap_context_t) == 40 * 8, "TrapContext must be 320 bytes");
...
#define TRAP_CONTEXT_SIZE  (40 * 8)
#define TASK_CONTEXT_SIZE  (24 * 8)
#define KTRAP_CONTEXT_SIZE (40 * 8)
...
#define TRAP_CTX_KScratch0(ctx)    ((ctx)->gpr[2])
