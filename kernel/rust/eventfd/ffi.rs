...
unsafe extern "C" {
    ...
    pub fn a20_eventfd_vfile_alloc() -> *mut vfile_t;
    pub fn a20_eventfd_vfile_free(vf: *mut vfile_t);
    pub fn a20_eventfd_vfile_priv(vf: *mut vfile_t) -> *mut c_void;
    pub fn a20_eventfd_vfile_init(vf: *mut vfile_t, ops: *mut vfile_ops_t, data: *mut c_void, flags: c_int);
    pub fn a20_eventfd_install_vfile(vf: *mut vfile_t, flags: c_int) -> c_int;
}
