...
unsafe extern "C" {
    ...
    pub fn net_socket_registry_init();
    ...
    pub fn net_sockaddr_set_port(addr: *mut c_void, len: usize, port: u16);
    pub fn net_sockaddr_in_local(addr: *const net_sockaddr_in_t) -> c_int;
    ...
    pub fn net_inet_socket_init(s: *mut net_socket_t) -> c_int;
    pub fn net_inet_socket_destroy(s: *mut net_socket_t);
    pub fn net_inet_bind_pcb(s: *mut net_socket_t, addr: *const c_void, addrlen: usize) -> c_int;
    pub fn net_inet_connect(
        s: *mut net_socket_t,
        addr: *const c_void,
        addrlen: usize,
    ...
    pub fn net_unix_socket_bind(s: *mut net_socket_t, addr: *const c_void, addrlen: usize) -> c_int;
    pub fn net_unix_socket_connect(s: *mut net_socket_t, addr: *const c_void, addrlen: usize) -> c_int;
    pub fn net_unix_socket_sendto(
        s: *mut net_socket_t,
        buf: *const c_void,
        len: usize,
        addr: *const c_void,
    ...
    pub fn net_alg_socket_bind(s: *mut net_socket_t, addr: *const c_void, addrlen: usize) -> c_int;
    ...
    pub fn net_dequeue_msg_locked_meta(
        s: *mut net_socket_t,
        buf: *mut c_void,
        len: usize,
        addr: *mut c_void,
    ...
    pub fn a20_socket_core_alloc_raw() -> *mut net_socket_t;
    pub fn a20_socket_core_free_raw(s: *mut net_socket_t);
    pub fn a20_socket_core_proc_current() -> *mut task_t;
    pub fn a20_socket_core_proc_set_wake_time(task: *mut task_t, when: u64);
    pub fn a20_socket_core_task_state(task: *mut task_t) -> c_int;
    pub fn a20_socket_core_task_set_state(task: *mut task_t, state: c_int);
    pub fn a20_socket_core_task_has_unblocked_signal_impl(task: *mut task_t) -> c_int;
    pub fn a20_socket_core_net_wait_ticks() -> u64;
    pub fn a20_socket_core_current_euid() -> c_int;
    pub fn a20_socket_core_current_has_cap_net_raw() -> c_int;
    pub fn a20_socket_core_sched();
    pub fn a20_socket_core_virtio_net_init_once() -> c_int;
    pub fn a20_socket_core_lwip_init();
    pub fn a20_socket_core_lwip_poll();
    pub fn a20_socket_core_lwip_format_status(buf: *mut c_char, bufsz: usize) -> c_int;
    pub fn a20_socket_core_append_status(buf: *mut c_char, bufsz: usize, used: c_int, bound: c_int, queued: c_int) -> c_int;
    pub fn a20_socket_core_log_init();
}
