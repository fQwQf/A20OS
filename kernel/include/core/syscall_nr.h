#ifndef _CORE_SYSCALL_NR_H
#define _CORE_SYSCALL_NR_H

/*
 * Kernel-internal Linux syscall number table.
 * Values are Linux ABI wire constants; the ABI layer re-exports them
 * (abi/linux/syscall_nr.h).  Internal code must include this header,
 * never anything under abi/.
 */

#define LINUX_SYSCALL_TABLE_SIZE 1024
