...
- `kernel/drvmod/examples/hda.c (hda.drv)`：PCI Intel HDA controller、输出 stream 和 PCM DMA。
...
- `kernel/drvmod/examples/pc_spkr.c (pc-spkr.drv)`：只支持 tone 的 x86 PC Speaker。
