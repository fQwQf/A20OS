...
`check-proc-step8-local` 运行双架构 debug/release、1 核/8 核累计压力矩阵；`check-proc-step8` 进一步运行双架构正式 functional tests。单项契约和故障定位见[testing/testing-gates.md](testing/testing-gates.md)，各阶段证明见`docs/testing/*-audit.md`。
