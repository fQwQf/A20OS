...
| Native ABI 内核入口 | `kernel/abi/native/` | 已实现 | 121 个 syscall 入口已完成（`syscall_table.def` 121 条），覆盖 core、handle、task、memory、path、ipc、net、time、security、debug、system info、sync 等分区。 |
