...
| Native ABI 内核入口 | `kernel/abi/native/` | 已实现 | 111 个 syscall 入口已完成（`syscall_table.def` 111 条），覆盖 core、handle、task、memory、path、ipc、net、time、security、debug、system info、sync 等分区。 |
