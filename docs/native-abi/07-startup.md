...
```text
Phase 0 ──→ Phase 1 ──→ Phase 2 ──→ Phase 3│            │            │            ││            │            │            └── 内核: A20_SPAWN_FORK_SELF│            │            │            └── 内核: 异步信号投递│            │            ✅ 已完成    └── 待实现│            ✅ 已完成    └── 内核: 全部 109 个 syscall ✅✅ 已完成    └── 内核: ~15 个基础 syscall ✅└── 内核: 启动协议 + abi_info + handle_close + vm_alloc ✅
