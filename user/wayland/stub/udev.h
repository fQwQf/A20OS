 ...
 * libinput/weston link against this; device discovery happens through
 * the libinput path backend instead. */
#ifndef _A20_STUB_UDEV_H
#define _A20_STUB_UDEV_H
...
int udev_get_userdata(struct udev *udev, void **userdata);
