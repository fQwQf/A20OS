...
int main(void)
{
    ...
    /*
     * Final-round images are mounted directly at /.  Their dynamic loader and
    ...
    const char *shell_path = final_contest ? "/a20/mksh" : "/bin/mksh";
    ...
    char **envp = final_contest ? final_envp : legacy_envp;
    ...
    char *script = final_contest ? "/a20/final_contest.sh" :
