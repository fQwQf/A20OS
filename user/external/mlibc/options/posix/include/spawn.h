...
int posix_spawn_file_actions_addchdir_np(posix_spawn_file_actions_t *__file_actions,
		const char *__path);
int posix_spawn_file_actions_addfchdir_np(posix_spawn_file_actions_t *__file_actions,
		int __fildes);
